...
class FillPermissionsForCourseInfo extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCourseInfo constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.course-info',
            'admin.course-info.index',
            'admin.course-info.create',
            'admin.course-info.show',
            'admin.course-info.edit',
            'admin.course-info.delete',
            'admin.course-info.bulk-delete',
        ]);
