...
class FillPermissionsForPurchaseCourseClass extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPurchaseCourseClass constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.purchase-course-class',
            'admin.purchase-course-class.index',
            'admin.purchase-course-class.create',
            'admin.purchase-course-class.show',
            'admin.purchase-course-class.edit',
            'admin.purchase-course-class.delete',
            'admin.purchase-course-class.bulk-delete',
        ]);
