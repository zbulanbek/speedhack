...
class FillPermissionsForCourseSection extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCourseSection constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.course-section.show',
            'admin.course-section.edit',
            'admin.course-section.delete',
            'admin.course-section.bulk-delete',
        ]);
