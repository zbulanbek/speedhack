...
class FillPermissionsForCourseClass extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCourseClass constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.course-class',
            'admin.course-class.index',
            'admin.course-class.create',
            'admin.course-class.show',
            'admin.course-class.edit',
            'admin.course-class.delete',
            'admin.course-class.bulk-delete',
        ]);
