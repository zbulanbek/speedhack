...
class FillPermissionsForSpeakingClub extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSpeakingClub constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.speaking-club',
            'admin.speaking-club.index',
            'admin.speaking-club.create',
            'admin.speaking-club.show',
            'admin.speaking-club.edit',
            'admin.speaking-club.delete',
            'admin.speaking-club.bulk-delete',
        ]);
