...
class FillPermissionsForTabCourse extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTabCourse constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.tab-course',
            'admin.tab-course.index',
            'admin.tab-course.create',
            'admin.tab-course.show',
            'admin.tab-course.edit',
            'admin.tab-course.delete',
            'admin.tab-course.bulk-delete',
        ]);
