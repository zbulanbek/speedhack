...
class FillPermissionsForCourseCategory extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCourseCategory constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.course-category.show',
            'admin.course-category.edit',
            'admin.course-category.delete',
            'admin.course-category.bulk-delete',
        ]);
