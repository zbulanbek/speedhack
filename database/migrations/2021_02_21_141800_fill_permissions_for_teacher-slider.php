...
class FillPermissionsForTeacherSlider extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTeacherSlider constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.teacher-slider',
            'admin.teacher-slider.index',
            'admin.teacher-slider.create',
            'admin.teacher-slider.show',
            'admin.teacher-slider.edit',
            'admin.teacher-slider.delete',
            'admin.teacher-slider.bulk-delete',
        ]);
