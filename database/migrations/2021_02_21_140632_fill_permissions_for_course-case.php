...
class FillPermissionsForCourseCase extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCourseCase constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.course-case',
            'admin.course-case.index',
            'admin.course-case.create',
            'admin.course-case.show',
            'admin.course-case.edit',
            'admin.course-case.delete',
            'admin.course-case.bulk-delete',
        ]);
