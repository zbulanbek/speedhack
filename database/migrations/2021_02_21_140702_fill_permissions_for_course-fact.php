...
class FillPermissionsForCourseFact extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCourseFact constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.course-fact',
            'admin.course-fact.index',
            'admin.course-fact.create',
            'admin.course-fact.show',
            'admin.course-fact.edit',
            'admin.course-fact.delete',
            'admin.course-fact.bulk-delete',
        ]);
