    ...
    <trial-lesson-layout>
        <section class="bg-account">
            <section class="lesson-modal-wrap">
                ...
                <div class="col-lg-6 scroll meto" style="padding-left: 0;" :class="{'not-active': $page.props.user.role_id === '4' || $page.props.user.role_id === '3'}">
                    <div class="desk-wrap">
                        <template v-for="(item, index) in tabs">
