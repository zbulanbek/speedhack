	...
	<aside class="ponel-wrap" :class="{'active': activeClass}">
		<div class="avatar-wrap">
			...
			<div class="name-wrap">
				...
				<a href="/account/profile" class="subtitle">Твой аккаунт</a>
			</div>
		</div>
		...
		<ul class="links-wrap">
			...
			<li>
				<a href="/account/courses"  class="links-item" :class="{'active': route().current() == 'account.courses'}">
					<div class="icon icon-1">
						<div class="active-point" v-if="active_trial_lesson"></div>
					</div>
					<div class="text">
						Мои курсы
					</div>
            ...
            <li>
                <a :href="route('account.catalog.courses.index')" class="links-item" :class="{'active': route().current() == 'catalog.courses.index'}">
            ...
            <li>
                <a :href="route('account.home-works.index')" class="links-item" :class="{'active': route().current() === 'account.home-works.index'}">
			...
			<li>
				<a href="/account/events" class="links-item" :class="{'active': route().current() == 'account.webinars'}">
			...
			<!-- <li>
				<a href="/account/webinars" class="links-item" :class="{'active': route().current() == 'metodist.results'}">
...
<script>
	export default {
	    ...
	    methods:{
            ...
            async activeCourse() {
            	try {
	           		const { data, status } = await window.axios.get(route('course.active').url());
	           		this.active_trial_lesson = data.active;
	           	} catch(e){
	           		console.log(e);
	           }
            }
