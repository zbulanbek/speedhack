	...
	<aside class="ponel-wrap" :class="{'active': activeClass}">
		<div class="avatar-wrap">
			...
			<div class="name-wrap">
				...
				<a href="" class="subtitle">Твой аккаунт</a>
			</div>
		</div>
		<ul class="links-wrap">
			<li>
				<a href="/account/profile" class="links-item" :class="{'active': route().current() == 'metodist.profile'}">
			...
			<li>
				<a href="/metodist/applications" class="links-item" :class="{'active': route().current() == 'metodist.applications'}">
			...
			<li>
				<a href="/metodist/apies" class="links-item" :class="{'active': route().current() == 'metodist.apies'}">
			...
			<!-- <li>
				<a href="/metodist/calendar" class="links-item" :class="{'active': route().current() == 'metodist.calendar'}">
			...
			<li>
				<a href="/metodist/results" class="links-item" :class="{'active': route().current() == 'metodist.results'}">
					<div class="icon icon-3"></div>
					<div class="text">
						Результаты
					</div>
			...
			<!-- <li>
				<a href="/account/webinars" class="links-item" :class="{'active': route().current() == 'account.webinars'}">
...
<!--			<li>-->
<!--				<a href="/metodist/timetables" class="links-item" :class="{'active': route().current() == 'metodist.timetables'}">-->
...
<style scoped>
	...
	.links-item.active .icon.icon-9{
		background-image: url('/images/icons/icon-9-b.svg');
	}
