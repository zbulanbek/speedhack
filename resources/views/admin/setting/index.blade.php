                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'display_name'">{{ trans('admin.setting.columns.display_name') }}</th>
                                        <th is='sortable' :column="'display_name'">{{ trans('admin.setting.columns.value') }}</th>
                                        <th is='sortable' :column="'key'">{{ trans('admin.setting.columns.key') }}</th>
