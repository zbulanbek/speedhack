                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'status_id'">{{ trans('admin.application.columns.time') }}</th>
                                        <th is='sortable' :column="'status_id'">{{ trans('admin.application.columns.methodist_status_id') }}</th>
                                        <th is='sortable' :column="'status_id'">{{ trans('admin.application.columns.comment') }}</th>
                                        <th></th>
                                    </tr>
                                ...
                                <tbody>
                                    <tr v-for="(item, index) in collection" :key="item.id" :class="bulkItems[item.id] ? 'bg-bulk' : ''">
                                        ...
                                        <td>@{{ item.methodist_status ? item.methodist_status.name : ''  }}</td>
                                        <td>@{{ item.comment }}</td>
                                        <td>
