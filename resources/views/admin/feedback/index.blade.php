                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'name'">{{ trans('admin.feedback.columns.name') }}</th>
                                        <th is='sortable' :column="'rate'">{{ trans('admin.feedback.columns.rate') }}</th>
                                        <th is='sortable' :column="'course_id'">{{ trans('admin.feedback.columns.course_id') }}</th>
