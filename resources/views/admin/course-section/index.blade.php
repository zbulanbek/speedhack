...
@section('title', trans('admin.course-section.actions.index'))

@section('body')

    <course-section-listing
        :data="{{ $data->toJson() }}"
        :url="'{{ url('admin/course-sections') }}'"
        inline-template>
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> {{ trans('admin.course-section.actions.index') }}
                        <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0"
                           href="{{ url('admin/course-sections/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.course-section.actions.create') }}
                        </a>
                    </div>
                        ...
                        <div class="card-block">
                            ...
                            <table class="table table-hover table-listing">
                                ...
                                <tr>
                                    ...
                                    <th is='sortable' :column="'id'">{{ trans('admin.course-section.columns.id') }}</th>
                                    <th is='sortable'
                                        :column="'course_id'">{{ trans('admin.course-section.columns.course_id') }}</th>
                                    <th is='sortable'
                                        :column="'title'">{{ trans('admin.course-section.columns.title') }}</th>
                                ...
                                <tr v-show="(clickedBulkItemsCount > 0) || isClickedAll">
                                    <td class="bg-bulk-info d-table-cell text-center" colspan="5">
                                            <span class="align-middle font-weight-light text-dark">{{ trans('brackets/admin-ui::admin.listing.selected_items') }} @{{ clickedBulkItemsCount }}.  <a
                                                    ...
                                                    @click="onBulkItemsClickedAll('/admin/course-sections')"
                                        ...
                                        <span class="pull-right pr-2">
                                                <button class="btn btn-sm btn-danger pr-3 pl-3"
                                                        @click="bulkDelete('/admin/course-sections/bulk-destroy')">{{ trans('brackets/admin-ui::admin.btn.delete') }}</button>
                                            </span>
                            ...
                            <div class="no-items-found" v-if="!collection.length > 0">
                                ...
                                <a class="btn btn-primary btn-spinner" href="{{ url('admin/course-sections/create') }}"
                                   role="button"><i
                                        class="fa fa-plus"></i>&nbsp; {{ trans('admin.course-section.actions.create') }}
                                </a>
                            </div>
                        </div>
                    </div>
